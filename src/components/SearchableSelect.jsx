    ...
    <div className="relative w-full" ref={wrapperRef}>
      <div 
        ...
        className={`flex items-center justify-between w-full min-h-[48px] px-4 py-3 bg-white border rounded-xl shadow-sm text-base cursor-pointer select-none transition-colors ${
          disabled ? 'bg-gray-100 border-gray-200 text-gray-400 cursor-not-allowed' : 'border-gray-300 hover:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-200'
        }`}
      >
